    ...
    if(request.query.token == null) {
      ...
      pool.query(theQuery, values)
              .then(result => {
                  ...
                  response.send(<html> <body> <img src = {__dirname + "/</body>ShootTheBreezeLogo.png"} alt="Shoot the Breeze Logo" width="180" height="150" style="vertical-align:bottom"> </img> </body> </html>)
              })
              .catch((err) => {
                  //log the error
                  //console.log(err)
